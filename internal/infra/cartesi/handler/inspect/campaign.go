...
import (
	...
	"github.com/henriquemarlon/shoal/internal/usecase/campaign"
...
func (h *CampaignInspectHandlers) FindCampaignsByInvestorAddress(env rollmelette.EnvInspector, payload []byte) error {
	...
	ctx := context.Background()
	findCampaignsByInvestor := campaign.NewFindCampaignsByInvestorUseCase(h.UserRepository, h.CampaignRepository)
